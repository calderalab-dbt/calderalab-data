{% if var('AMAZONSPADS') and var('SPPlacementCampaignsReport',True) %}
    {{ config( enabled = True ) }}
{% else %}
...
table_pattern=var('sp_placementcampaigns_tbl_ptrn','%sponsoredproducts%placementcampaignsreport'),
exclude=var('sp_placementcampaigns_tbl_exclude_ptrn',''),
